                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap text-center" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset($slider->photo) }}" width="100" height="64"></td>
                                <td>{{ $slider->alt }}</td>
                                <td>{{ date('d.m.Y h:i:s',strtotime($slider->created_at)) }}</td>
                                <td class="text-center">
                                    <a href="{{ route('backend.sliderStatus',['id'=>$slider->id]) }}" title="@lang('backend.status')">
                                        <input type="checkbox" id="switch" switch="primary" {{ $slider->status == 1 ? 'checked' : '' }} />
