                ...
                <div class="col-xl-6 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('backend.settings.store') }}" method="POST" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label>@lang('backend.name') <span class="text-danger">*</span></label>
                                    <input type="text" name="name" class="form-control" required="" data-parsley-minlength="6" placeholder="instagram">
