...
<body style="
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <!-- LOGO -->
        <tr>
            <td bgcolor="#246429" align="center">
        ...
        <tr>
            <td bgcolor="#246429" align="center" style="padding: 0px 10px 0px 10px">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                    <tr>
                  ...
                  letter-spacing: 4px;
                  line-height: 48px;">
                            <img src="https://i.ibb.co/Kz1mw0y/logo.png" width="125" height="120" style="display: block; border: 0px" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px">
                ...
                ">
                            ...
                            {{-- </p>--}}
                            <p style="margin: 0;color: black">
                                Yazıçılarınızdan {{ $writer_name }} yeni paylaşım etmək istəyir!
                            </p>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 60px 30px">
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="border-radius: 3px" bgcolor="#246429">
                ...
                ">
                            <p style="margin: 0">
                                <a href="#" target="_blank" style="color: #246429"> {{ route('backend.pendingPostId',$post_id) }} </a>
                            </p>
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td bgcolor="#f4f4f4" align="center" style="padding: 30px 10px 0px 10px">
                ...
                ">
                            ...
                            <p style="margin: 0">
                                <a href="{{ route('frontend.contact-us-page') }}" target="_blank" style="color: #246429"> Daha çox köməyə ehtiyacınız var?</a>
                            </p>
                        </td>
                    </tr>
                </table>
