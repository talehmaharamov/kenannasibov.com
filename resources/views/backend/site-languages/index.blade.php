                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ route('backend.site-languages.create') }}"
                        ...
                        <table id="datatable-buttons"
                            ...
                            @foreach($siteLanguages as $sl)
                                <tr>
                                    ...
                                    <td class="text-center"><img src="{{ asset($sl->icon) }}" width="32" height="24"></td>
                                    <td class="text-center">
                                        <a href="{{ route('backend.siteLanStatus',['id'=>$sl->id]) }}"
                                           class="btn btn-{{ $sl->status == 1 ? 'success' : 'secondary' }}">{{ $sl->status == 1 ? __('backend.active') : __('backend.deactive') }}</a>
                                    </td>
                                    <td class="text-center">
                                        <a class="btn btn-info"
                                           href={{ route('backend.site-languages.edit',['site_language'=>$sl->id]) }}>
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a class="btn btn-danger"
                                           href="{{ route('backend.delSiteLang',['id'=>$sl->id]) }}">
