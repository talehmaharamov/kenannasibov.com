                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('backend.categoryStatus',['id'=>$category->id]) }}"
                                           class="btn btn-{{ $category->status == 1 ? 'success' : 'secondary' }}">{{ $category->status == 1 ? __('backend.active') : __('backend.deactive') }}</a>
                                    </td>
                                    <td class="text-center">
                                        <a class="btn btn-info"
                                           href={{ route('backend.categories.edit',['category'=>$category->id]) }}>
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a class="btn btn-danger"
                                           href="{{ route('backend.delCategory',['id'=>$category->id]) }}">
