        ...
        <div class="row justify-content-center py-4 my-2">
            <div class="col-md-4 col-lg-4 mb-4 mb-lg-0">
                ...
                <form action="{{ route('frontend.newsletter') }}" method="POST" class="me-4 mb-3 mb-md-0">
                    ...
                    <div class="input-group input-group-rounded">
                        <input class="form-control form-control-sm bg-light" placeholder="@lang('backend.email')"
                               name="newsletterEmail" id="newsletterEmail" type="email" required>
                        <button class="btn btn-light text-color-dark" type="submit">
                            <strong>@lang('frontend.send')</strong></button>
                    </div>
                </form>
            </div>
            <div class="col-md-3 col-lg-3 mb-5 mb-lg-0">
                ...
                <ul class="list list-unstyled mb-0">
                    <li class="mb-0"><i class="fas fa-angle-right"></i> <a
                            href="{{ route('frontend.index') }}">@lang('backend.home-page')</a></li>
                    <li class="mb-0"><i class="fas fa-angle-right"></i> <a
                            href="{{ route('frontend.allPosts') }}">@lang('backend.news')</a></li>
                    <li class="mb-0"><i class="fas fa-angle-right"></i> <a
                ...
                <div class="contact-details">
                    ...
                    <ul class="list list-icons list-icons-lg">
                        <li class="mb-1"><i class="fas fa-location-arrow text-color-primary"></i>
                            <label class="m-0"><a target="_blank" href="https://goo.gl/maps/NNqmad5QY6L9Q97x9">Dırnıs
                                    mərasi evi</a></label>
                        </li>
                        ...
                        <li class="mb-1"><i class="far fa-envelope text-color-primary"></i>
                            <label class="m-0"><a
                                    href="mailto:{{ settings('email') }}">{{ settings('email') }}</a></label>
                        </li>
                    </ul>
                </div>
            </div>
